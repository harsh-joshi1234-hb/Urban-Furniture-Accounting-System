...
export const portalService = {
  ...
  /** Request a cash/bank payment (creates a DRAFT record for admin approval). */
  requestPayment: ({ invoiceId, amount, paymentMethod, reference, note }) =>
    api.post('/portal/payments', { invoiceId, amount, paymentMethod, reference, note }),
